...
from schemas.user import UserCreateDTO, UserHistoryCreateDTO, UserUpdatePasswordDTO, UserUpdatePersonalDTO, UserUpdateNameDTO, UserUpdatePhoneDTO
...
class BaseUserService(ABC):
    ...
    @abstractmethod
    async def update_name(self, user_id: Any, data: UserUpdateNameDTO) -> None:
        ...

    @abstractmethod
    async def update_phone(self, user_id: Any, data: UserUpdatePhoneDTO) -> None:
        ...
...
class UserService(BaseUserService):
    ...
    async def update_name(self, user_id: Any, data: UserUpdateNameDTO) -> None:
        ...
        if not user:
            raise RuntimeError('User not found')
        await self._repository.update_name(
            user_id=user_id,
    ...
    async def update_phone(self, user_id: Any, data: UserUpdatePhoneDTO) -> None:
        ...
        if not user:
            raise RuntimeError('User not found')
        await self._repository.update_phone(user_id=user_id, phone=data.phone)